...
public:
    ...
    void setupUi(QDialog *Dialog1)
    {
        ...
        pushButton->setGeometry(QRect(240, 190, 93, 28));
        label = new QLabel(Dialog1);
        label->setObjectName(QStringLiteral("label"));
        label->setGeometry(QRect(131, 30, 91, 41));
    ...
    void retranslateUi(QDialog *Dialog1)
    {
        ...
        pushButton->setText(QApplication::translate("Dialog1", "\350\277\224\345\233\236", Q_NULLPTR));
        label->setText(QApplication::translate("Dialog1", "\344\270\200\345\217\267\347\252\227\345\217\243", Q_NULLPTR));
    } // retranslateUi
