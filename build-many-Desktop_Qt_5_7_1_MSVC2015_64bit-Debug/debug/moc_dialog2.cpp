...
QT_MOC_LITERAL(3, 18, 3), // "car"
QT_MOC_LITERAL(4, 22, 21), // "on_pushButton_clicked"
QT_MOC_LITERAL(5, 44, 13) // "on_ok_clicked"

    },
    "Dialog2\0sendData\0\0car\0on_pushButton_clicked\0"
    "on_ok_clicked"
};
...
void Dialog2::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendData((*reinterpret_cast< car(*)>(_a[1]))); break;
        ...
        {
            typedef void (Dialog2::*_t)(car );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Dialog2::sendData)) {
                *result = 0;
                return;
            }
        }
